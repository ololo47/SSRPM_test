import svgPaths from "./svg-0elvtly9sq";
...
function DateAndOptions() {
  return (
    <div className="content-stretch flex gap-1.5 items-center justify-end relative shrink-0" data-name="Date and options">
...
function Ratings() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Ratings">
      <StarRatings />
      <DateAndOptions />
    </div>
  );
...
function RestaurantInfo() {
  return (
    <div className="content-stretch flex gap-0.5 items-start justify-start relative shrink-0" data-name="Restaurant info">
...
function Photos() {
  return (
    <div className="content-stretch flex gap-1 items-center justify-start relative shrink-0" data-name="Photos">
      <Icon17 />
...
function ReviewActions() {
  return (
    <div className="bg-[#ffffff] box-border content-stretch flex gap-1 items-center justify-center p-[8px] relative rounded-lg shrink-0" data-name="Review actions">
      <Photos />
    </div>
  );
}
...
function PriceDetails() {
  return (
    <div className="content-stretch flex gap-1 items-center justify-start relative shrink-0" data-name="Price details">
      <Icon18 />
      <div className="flex flex-col font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#000000] text-[14px] text-nowrap tracking-[-0.0126px]">
...
function PriceAndQuantity() {
  return (
    <div className="bg-[#ffffff] box-border content-stretch flex gap-1 items-center justify-center p-[8px] relative rounded-lg shrink-0" data-name="Price and quantity">
      <PriceDetails />
    </div>
  );
}
...
function ReviewDetails() {
  return (
    <div className="content-stretch flex gap-1 items-center justify-start relative shrink-0 w-full" data-name="Review details">
      <Thumbnail />
      <ReviewActions />
      <PriceAndQuantity />
    </div>
...
function ReplyCard() {
  return (
    <div className="bg-[#ffffff] relative rounded-2xl shrink-0 w-full" data-name="Reply card">
